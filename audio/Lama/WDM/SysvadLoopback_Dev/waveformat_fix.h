...
// Forward declaration of structure types needed for function parameters
#ifndef PKSDATARANGE_DEFINED
#define PKSDATARANGE_DEFINED
// Define full structure to avoid undefined type error
...
typedef struct _KSDATARANGE {
    KSDATAFORMAT DataFormat;
    // Additional fields may vary - we're just providing the basic structure
} KSDATARANGE, *PKSDATARANGE;
#endif

// Safe helper functions for KSDATARANGE structure access
// Include our compatible KSDATARANGE helper functions
