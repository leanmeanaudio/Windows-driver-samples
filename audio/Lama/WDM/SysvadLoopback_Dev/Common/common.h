...
#define SYSVAD_EDEVICETYPE_DEFINED
typedef enum _DeviceType
{
    ...
    // Add Lama-specific device types here
    eLamaLoopbackRenderDevice,
    eLamaLoopbackCaptureDevice,
    eMaxDeviceType,
    eUnknownType = 0xFF // Unknown device type for default handling
} eDeviceType;
#endif // SYSVAD_EDEVICETYPE_DEFINED
...
//
#ifndef SYSVAD_PINTYPE_DEFINED
#define SYSVAD_PINTYPE_DEFINED
...
{
    int                                PinType; // Use int instead of PINTYPE to avoid compiler errors
...
// Define PFNCREATEMINIPORT if not already defined to avoid conflicts
...
#endif // PFNCREATEMINIPORT_DEFINED
...
//
// Define physical connection table structure
//
#ifndef _PHYSICALCONNECTIONTABLE_DEFINED
#define _PHYSICALCONNECTIONTABLE_DEFINED
typedef struct _PHYSICALCONNECTIONTABLE
{
    ULONG                      ulTransformerId;      // ID of the associated stream
    ULONG                      ulNotifyId;           // ID used with KSEVENT_PINCAPS_FORMATCHANGE to identify this connection
    ULONG                      ulPinId;              // Software PinId connected to the stream
    KSPIN_DATAFLOW             DataFlow;             // Data flow direction (out for render, in for capture)
    KSDATAFORMAT_WAVEFORMATEX* WaveFormat;           // Format of this connection
} PHYSICALCONNECTIONTABLE, *PPHYSICALCONNECTIONTABLE;
#endif // _PHYSICALCONNECTIONTABLE_DEFINED
...
typedef struct _ENDPOINT_MINIPAIR 
{
    ...
    PPHYSICALCONNECTIONTABLE       PhysicalConnections;
